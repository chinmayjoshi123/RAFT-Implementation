...
try:
    ...
    print('before_decoding:', resp_msg.decode('utf-8'))
    ...
    if decoded_resp['request'] == 'LEADER_INFO':
        ...
        final_resp, add = skt.recvfrom(1024)
        print('before_decoding:', final_resp.decode('utf-8'))
        decoded_final_resp = json.loads(final_resp.decode('utf-8'))
        print(decoded_final_resp)
